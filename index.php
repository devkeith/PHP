...
<body>
    <div class="login-container">
        <form class="login-card" action="backend.php" method="POST">
            ...
            <!-- Dual Login Input (Email or Student ID) -->
            <div class="input-field">
                <label>StudentID or Email Address</label>
				<input type="text" id="student_id email_address" name="password" required placeholder="student id/emal">
            </div>

            <!-- Password Input with Inline Show/Hide and Forgot Link -->
            <div class="input-field">
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button" id="toggle_password_btn" class="toggle-password" aria-label="Show password">
                        <!-- Native SVG Eye Icon -->
                        <svg xmlns="http://w3.org" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="eye-icon">
    ...
    <!-- Vanilla Javascript Password Visibility Toggle Logic -->
    <script>
        document.getElementById('toggle_password_btn').addEventListener('click', function() {
            ...
            // Toggle visual styling to mimic active click states
